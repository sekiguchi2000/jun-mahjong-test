...
export const COM_CHARACTERS = Object.freeze([
  ...
  {
    id: 'mamoru', name: 'まもる', profile: 'defense', portrait: 'generic',
    tagline: 'ガイドの「守り」思考',
    description: '手の価値よりリスクが高ければ回し、無理なら降りる。ガイドの守り思考と同一。',
  },
  {
    id: 'seitaro', name: '征太郎', profile: 'balance', portrait: 'generic',
    tagline: 'ガイドの「バランス」思考',
    description: '攻めと守りの中間。手の価値と危険を天秤にかける。ガイドのバランス思考と同一。',
  },
  {
    id: 'gouda', name: '剛田', profile: 'attack', portrait: 'generic',
    tagline: 'ガイドの「攻め」思考',
    description: '高めを狙って多少のリスクは冒す。ガイドの攻め思考と同一。',
  },
  {
    id: 'daisuke', name: 'ダイスケ', profile: 'daisuke', portrait: 'generic',
    tagline: '脇目もふらぬ最速あがり',
    description: '相手のリーチや気配は一切見ない。待ちが残り1枚でもリーチ、カンできれば必ずカン。',
  },
  {
    id: 'chen', name: '陳', profile: 'chen', portrait: 'generic',
    tagline: '鉄壁のダマ職人',
    description: '絶対にリーチしない。高めは狙わず安くても早くあがる。リーチされたら徹底的に降りる。',
  },
  {
    id: 'sawaka', name: 'サワカ', profile: 'sawaka', portrait: 'generic',
    tagline: '手役ロマン派',
