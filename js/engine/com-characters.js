// com-characters.js — COMキャラクターのレジストリ (v3 / 2026-09-03 新キャスト9人)
...
export const COM_CHARACTERS = Object.freeze([
  ...
  {
    id: 'daisuke', name: '小森ダイスケ', kana: 'こもり だいすけ', title: '教科書どおりの効率派',
    profile: 'analyst', portrait: 'daisuke', voice: 'joe',
    tagline: '効率型・受入枚数を最大化',
    description: '標準バランスの効率派。押し引きも鳴きも教科書どおり。',
    intro: '牌効率の本を読み込んだ20代の雀荘常連。受け入れ枚数を最大にする打牌を淡々と選び、押し引きも鳴きも教科書どおり。癖がない分、実力がそのまま出る基準の相手。',
    quote: '枚数が多いほうを切る。それ以上でも以下でもないです。',
  ...
  {
    id: 'ronbolt', name: 'ロンボルト', kana: 'ろんぼると', title: '最速あがり機械',
    profile: 'daisuke', portrait: 'ronbolt',
    tagline: '脇目もふらぬ最速あがり',
    description: '相手のリーチや気配は一切見ない。待ちが残り1枚でもリーチ、カンできれば必ずカン。',
    intro: 'レトロな麻雀ロボ。相手のリーチも気配も一切見ず、自分の手をあがることだけを計算する。待ちが残り1枚でもリーチ、カンできれば必ずカン。放銃も多いが、速さは全キャラ最速。',
    quote: 'テンパイ。リーチ。以上。',
    style: { attack: 5, defense: 1, call: 2, riichi: 5 },
  },
  {
