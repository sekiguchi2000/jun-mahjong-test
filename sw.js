...
const CACHE = 'jun-mahjong-v124-cinematics';
...
const ASSETS = [
  ...
  'js/engine/decision-contract.js', 'js/engine/decision-log.js', 'js/engine/com-characters.js?v=5', 'js/engine/yaku-guide.js?v=2', 'js/engine/progression.js?v=1',
