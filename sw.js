...
const CACHE = 'jun-mahjong-v44-are-report';
...
const ASSETS = [
  ...
  'css/product-ui-v17.css?v=1', 'css/are-report-v1.css?v=1', 'css/win-cinematic-v1.css?v=3', 'css/tile-3d-v1.css?v=1', 'css/riichi-stick-v1.css?v=1', 'css/title-cinematic-v1.css?v=1', 'css/table-physical-v2.css?v=1', 'css/table-geometry-v3.css?v=1', 'css/table-geometry-v4.css?v=1', 'css/tile-cuboid-v2.css?v=1', 'css/tabletop-projection-v1.css?v=1', 'css/webgl-tabletop-v1.css?v=4', 'manifest.webmanifest',
  'js/ui/main.js?v=40', 'js/ui/are-report.js?v=1', 'js/ui/register-sw.js?v=14', 'js/ui/tilesvg.js?v=10', 'js/ui/tile-cuboid.js?v=2', 'js/ui/tabletop-projection.js?v=1', 'js/ui/webgl-tabletop.js?v=4', 'js/ui/gameplay-controls.js?v=12',
  ...
  'js/engine/review-evaluator.js?v=18', 'js/engine/session-snapshot.js', 'js/engine/decision-coach.js?v=2',
