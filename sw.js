...
const CACHE = 'jun-mahjong-v115-claim-pick';
...
const ASSETS = [
  ...
  'css/product-ui-v17.css?v=2', 'css/are-report-v1.css?v=4', 'css/stats-v1.css?v=1', 'css/win-cinematic-v1.css?v=4', 'css/tile-3d-v1.css?v=1', 'css/riichi-stick-v1.css?v=1', 'css/title-cinematic-v1.css?v=1', 'css/table-physical-v2.css?v=1', 'css/table-geometry-v3.css?v=1', 'css/table-geometry-v4.css?v=1', 'css/tile-cuboid-v2.css?v=1', 'css/tabletop-projection-v1.css?v=1', 'css/webgl-tabletop-v1.css?v=6', 'css/progression-ui-v83.css?v=1', 'manifest.webmanifest',
