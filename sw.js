...
const CACHE = 'jun-mahjong-v76-flush-deadwait';
...
const ASSETS = [
  ...
  'js/ui/main.js?v=56', 'js/ui/stats-store.js?v=1', 'js/ui/are-report.js?v=1', 'js/ui/register-sw.js?v=14', 'js/ui/tilesvg.js?v=10', 'js/ui/tile-cuboid.js?v=2', 'js/ui/tabletop-projection.js?v=1', 'js/ui/webgl-tabletop.js?v=4', 'js/ui/gameplay-controls.js?v=12',
