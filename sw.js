...
const CACHE = 'jun-mahjong-v127-stick-no-stall';
...
const ASSETS = [
  ...
  'js/engine/decision-contract.js', 'js/engine/decision-log.js', 'js/engine/com-characters.js?v=6', 'js/engine/yaku-guide.js?v=2', 'js/engine/progression.js?v=2',
  ...
  'assets/audio/sfx/stick_drop_v1.ogg',
  'assets/audio/sfx/slam_v1.ogg',
  'assets/audio/sfx/yakuman_hit_v1.ogg',
